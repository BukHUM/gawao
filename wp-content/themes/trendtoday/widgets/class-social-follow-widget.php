 ...
 */
class TrendToday_Social_Follow_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'trendtoday_social_follow',
            __( 'Trend Today: Social Follow', 'trendtoday' ),
            array( 'description' => __( 'Display social media follow links', 'trendtoday' ) )
        );
    }

    public function widget( $args, $instance ) {
        $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'ติดตามเรา', 'trendtoday' );
        $has_any = false;
