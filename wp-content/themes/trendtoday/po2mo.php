 ...
 * If no args: compiles trendtoday-en_US.po to languages/en_US.mo (WordPress loads {locale}.mo for themes).
 */
$theme_dir = __DIR__;
$po_file   = $argc >= 2 ? $argv[1] : $theme_dir . '/languages/trendtoday-en_US.po';
