 ...
 */
$theme_dir = __DIR__;
$out_file  = $theme_dir . '/languages/trendtoday.pot';
$domain    = 'trendtoday';
...
$out = '';
$out .= '# Copyright (C) 2025 Trend Today' . "\n";
$out .= '# This file is distributed under the same license as the Trend Today theme.' . "\n";
$out .= 'msgid ""' . "\n";
$out .= 'msgstr ""' . "\n";
$out .= '"Project-Id-Version: Trend Today 1.0.0\n"' . "\n";
